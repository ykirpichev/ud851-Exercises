...
public class NotificationUtils {
    ...
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "water-reminder-notification-channel";
    private static final int WATER_REMINDER_NOTIFICATION_ID = 4321;
