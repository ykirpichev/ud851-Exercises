...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.e(LOG_TAG, "Failed to parse party size text: " + ex.getMessage());
        }

        if (addNewGuest(mNewGuestNameEditText.getText().toString(), partySize) != -1) {
    ...
    private long addNewGuest(String s, int partySize) {
        ContentValues contentValues = new ContentValues();

        contentValues.put(WaitlistContract.WaitlistEntry.COLUMN_GUEST_NAME, s);
